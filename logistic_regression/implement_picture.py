...
# loaded_model = joblib.load('logistic_regression/trained_models/2class_3ksamples_77%.pk1')
loaded_model = joblib.load('logistic_regression/trained_models/7class_3ksample_42%.pk1')
